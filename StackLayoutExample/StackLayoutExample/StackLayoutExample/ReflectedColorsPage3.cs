...
{
    public class ReflectedColorsPage3 : ContentPage
    {
        public ReflectedColorsPage3()
        {
            ...
            Content = new ScrollView { Content = stackLayout , Orientation= ScrollOrientation.Horizontal};
        }
